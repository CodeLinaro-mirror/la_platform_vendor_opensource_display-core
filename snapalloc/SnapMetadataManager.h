 ...
 private:
  ...
  std::unordered_map<vendor_qti_hardware_display_common_MetadataType, MetadataHelper>
      metadata_helper_function_map = {
          ...
          {MD_PP_PARAM_INTERLACED, &SnapMetadataManager::PPParamInterlacedHelper},
          ...
          {MD_MAP_SECURE_BUFFER, &SnapMetadataManager::MapSecureBufferHelper},
          {MD_LINEAR_FORMAT, &SnapMetadataManager::LinearFormatHelper},
  ...
  std::unordered_map<vendor_qti_hardware_display_common_MetadataType,
      ...
      metadatatype_traits_map{
          ...
          {BLEND_MODE, {true}},
          {VT_TIMESTAMP, {true}},
          {MD_PP_PARAM_INTERLACED, {true}},
          {VIDEO_PERF_MODE, {true}},
          {GRAPHICS_METADATA, {true}},
          {UBWC_CR_STATS_INFO, {true}},
          {REFRESH_RATE, {true}},
          {MD_MAP_SECURE_BUFFER, {true}},
          {MD_LINEAR_FORMAT, {true}},
