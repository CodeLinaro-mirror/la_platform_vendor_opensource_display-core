...
[[clang::no_destroy]] static std::unordered_map<SnapPixelFormat, FormatTraits> format_traits_map{
    ...
    // ubwc_supported, width_even, height_even, camera_custom_format}}
    {{SnapPixelFormat::RGBA_8888}, {true, false, false, false, false, true, false, false, false}},
    {{SnapPixelFormat::RGBX_8888}, {true, false, false, false, false, true, false, false, false}},
    {{SnapPixelFormat::RGBA_FP16}, {true, false, false, false, false, true, false, false, false}},
    {{SnapPixelFormat::YCBCR_P010}, {false, true, false, false, false, true, false, false, false}},
    {{SnapPixelFormat::BGRA_8888}, {true, false, false, false, false, false, false, false, false}},
    {{SnapPixelFormat::RGB_888}, {true, false, false, false, false, false, false, false, false}},
    {{SnapPixelFormat::YCbCr_420_SP},
     {false, true, false, false, false, true, false, false, false}},
    {{SnapPixelFormat::NV21_ZSL}, {false, true, false, false, false, false, false, false, false}},
    {{SnapPixelFormat::YCrCb_420_SP},
     {false, true, false, false, false, true, false, false, false}},
    {{SnapPixelFormat::TP10}, {false, true, false, false, false, true, false, false, false}},
    {{SnapPixelFormat::RGB_565}, {true, false, false, false, false, false, false, false, false}},
    {{SnapPixelFormat::YV12}, {false, true, false, false, false, false, true, true, false}},
    {{SnapPixelFormat::R_8}, {true, false, false, false, false, false, false, false, false}},
    {{SnapPixelFormat::RGBA_1010102},
     {true, false, false, false, false, true, false, false, false}},
    {{SnapPixelFormat::BGR_565}, {true, false, false, false, false, true, false, false, false}},
    {{SnapPixelFormat::RG_88}, {true, false, false, false, false, false, false, false, false}},
    {{SnapPixelFormat::RAW8}, {false, false, false, false, false, false, false, false, false}},
    ...
    {{SnapPixelFormat::DEPTH_24_STENCIL_8}, {false, false, true, true, false, false, false, false}},
    {{SnapPixelFormat::DEPTH_32F}, {false, false, true, true, false, true, false, false, false}},
    {{SnapPixelFormat::DEPTH_32F_STENCIL_8},
     {false, false, true, true, false, true, false, false, false}},
    {{SnapPixelFormat::STENCIL_8}, {false, false, true, true, false, true, false, false, false}},
    {{SnapPixelFormat::BLOB}, {false, false, false, false, false, false, false, false, false}},
    {{SnapPixelFormat::YCBCR_422_SP},
     {false, true, false, false, false, false, true, false, false}},
    {{SnapPixelFormat::YCBCR_422_I}, {false, true, false, false, false, false, true, false, false}},
    ...
    {{SnapPixelFormat::YCrCb_422_I}, {false, true, false, false, false, false, true, false, false}},
    ...
    {{SnapPixelFormat::COMPRESSED_SRGB8_ALPHA8_ASTC_12x12_KHR},
     {true, false, false, false, true, false, false, false, false}},
    {{SnapPixelFormat::RGBA_4444}, {true, false, false, false, false, false, false, false, false}},
    {{SnapPixelFormat::RGBA_5551}, {true, false, false, false, false, false, false, false, false}},
    {{SnapPixelFormat::Y16}, {false, true, false, false, false, false, false, false, false}},
    {{SnapPixelFormat::YCBCR_P210}, {false, true, false, false, false, true, false, false, false}},
    {{SnapPixelFormat::NV12_UBWC_MIPMAP},
     {false, true, false, false, false, true, false, false, true}},
    {{SnapPixelFormat::NV12_MIPMAP}, {false, true, false, false, false, true, false, false, true}},
    {{SnapPixelFormat::TP10_UBWC_MIPMAP},
     {false, true, false, false, false, true, false, false, true}},
    {{SnapPixelFormat::C_8}, {false, true, false, false, false, false, false, false, false}},
    {{SnapPixelFormat::P010_MIPMAP}, {false, true, false, false, false, true, false, false, true}},
    {{SnapPixelFormat::BAYER16_UBWC}, {false, true, false, false, false, true, false, false, true}},
...
bool IsCameraCustomFormat(SnapPixelFormat format, SnapPixelFormatModifier modifier) {
  ...
  auto format_traits = format_traits_map.find(format);
  if (format_traits != format_traits_map.end()) {
    if (format_traits->second.camera_custom_format) {
      return true;
    }
  }
  return false;
