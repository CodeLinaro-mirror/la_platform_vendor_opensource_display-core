...
class SmartSelectionAdapter : public SmartSelectionIntf {
 public:
  ...
  /**
     ...
     */
  int ProcessOps(SmartSelectionOp op, const sdm::GenericPayload &in,
 ...
 private:
  ...
  int DoFlushSelected(const sdm::GenericPayload &in, sdm::GenericPayload *out);
  ...
  int DoQuerySelectorStatus(const sdm::GenericPayload &in, sdm::GenericPayload *out);
  ...
  QaiorSS_Context_t *(*fn_init_)(QaiorSS_Pipeline_t *, const char *, QaiorSS_emitCallback,
                                 void *) = nullptr;
  ...
  QaiorSS_Status_t (*fn_enqueue_)(QaiorSS_Pipeline_t *, QaiorSS_Context_t *,
                                  const QaiorSS_FrameHandle_t *) = nullptr;
  ...
  QaiorSS_Status_t (*fn_flushSelected_)(QaiorSS_Pipeline_t *, QaiorSS_Context_t *, const char *,
                                        const char *) = nullptr;
  QaiorSS_Status_t (*fn_deleteByConfig_)(QaiorSS_Pipeline_t *, QaiorSS_Context_t *, const char *,
  ...
  QaiorSS_Status_t (*fn_waitUntilIdle_)(QaiorSS_Pipeline_t *, QaiorSS_Context_t *,
                                        int32_t) = nullptr;
  int (*fn_querySelectorStatus_)(QaiorSS_Context_t *, const char *) = nullptr;
};
