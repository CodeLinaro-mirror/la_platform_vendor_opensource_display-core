...
class SDMLayerBuilder : public SDMDisplayLayerBuilderIntf {
 public:
  ...
  DisplayError SetRenderLayerReferenceSpaceType(
      ...
      SDMRenderLayerReferenceSpaceType reference_layer_space_type) override;
  DisplayError SetCompositionLayerType(uint64_t display, int64_t layer,
                                       SDMCompositionLayerType comp_layer_type) override;
  DisplayError SetLayerPose(uint64_t display, int64_t layer, SDMLayerPose layer_pose) override;
  DisplayError SetLayerQuadSize(uint64_t display, int64_t layer,
                                SDMLayerQuadSize layer_quad_size) override;
  DisplayError SetLayerFrustum(uint64_t display, int64_t layer,
                               SDMLayerFrustum layer_frustum) override;
  DisplayError SetLayerPlaneEquation(uint64_t display, int64_t layer,
                                     SDMLayerPlaneEquation plane_equation) override;
  DisplayError SetLayerVisibilityType(uint64_t display, int64_t layer,
                                      SDMLayerVisibilityType layer_visibility_type) override;
  ...
  DisplayError SetLayerPerFrameMetadata(uint64_t display_id, int64_t layer_id,
                                        uint32_t num_elements, const int32_t *int_keys,
                                        const float *metadata) override;
